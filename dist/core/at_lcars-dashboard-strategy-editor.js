// ====================================================================
// at_lcars DASHBOARD STRATEGY - EDITOR
// ====================================================================
import { getEditorStyles } from './editor/at_lcars-editor-styles.js';
import { renderEditorHTML } from './editor/at_lcars-editor-template.js';
import { 
...
class at_lcarsDashboardStrategyEditor extends HTMLElement {
  ...
  _updateFavoritesList() {
    ...
    import('./editor/at_lcars-editor-template.js').then(module => {
...
customElements.define("at_lcars-dashboard-strategy-editor", at_lcarsDashboardStrategyEditor);