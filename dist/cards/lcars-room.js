...
class AtLcarsRoom extends Card {
  ...
  get css_tablet() {
    ...
    @media (width > 550px){
      .room {
        ...
        300px 30px    4px      46px         4px    1fr     1fr     8px     24px    20px   4px     10px;
  ...
  get css_mobile_new() {
    ...
    .room {
      ...
      grid-template-rows: 0.7fr 0.3fr 22px 8px 4px 8px 22px 1.3fr 30px 30px;
      gap: 0px 0px;
      grid-auto-flow: row;
      grid-template-areas:
  ...
  _render() {
    ...
    [
      ...
      this._addCard(".power", 'bubble-card', `power${e}`,
        lcars_bubble_lozenge(e, this.em.color3, this.em.color1, false, "45px"),
        e
      );
    });
    //------------------------------------------------------------------
